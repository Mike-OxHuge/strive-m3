  ...
  gameBegin.addEventListener("click", (a, b) => {
    ...
    document.getElementById("checker").addEventListener("click", (x, y, z) => {
      ...
      if (attempt > randomNumber) {
        ...
        <div class="alert alert-danger fadeInLeft my-4" style='max-width:50%' role="alert">
        ...
        document.getElementById("results").innerHTML = `
        <div class="alert alert-warning fadeInRight my-4" style='max-width:50%' role="alert">
