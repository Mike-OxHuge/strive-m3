    ...
    if(search.length !=0){
        ...
        .then ((albums)=>{
            ...
            albums.data.forEach(album => {
                ...
                cards.innerHTML += `<a href="details.html"><div class="mb-4 text-center col-sm-6 col-md-4 col-lg-2 cover">
                <img class="img-fluid" src="${album.album.cover_big}"></a><h6 class="text-white album-title mt-1">${album.album.title}</h6></div>
                <div class="mb-4 text-center">`
            })
        })
        .catch(err => {
